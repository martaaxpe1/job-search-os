---
name: review-as-interviewer
description: Three Laws interview grading — structure, specificity, skill demonstration — with full rewrite using your real experience.
---
...
1. **Say No questions** -- Practice committing to the unpopular decision.
2. **Failure questions** -- Practice telling a real failure. Not a humble-brag.
3. **Tell Me About Yourself** -- Rewrite using the addressing-weaknesses framework from career-plan.md.
```
